...
#define SWITCH_DISPLAY_WIDTH		108.0
#define SWITCH_WIDTH				171.0
#define SWITCH_HEIGHT				28.0

#define RECT_FOR_OFF		CGRectMake(-62.0, 0.0, SWITCH_WIDTH, SWITCH_HEIGHT)
#define RECT_FOR_ON			CGRectMake(0.0, 0.0, SWITCH_WIDTH, SWITCH_HEIGHT)
#define RECT_FOR_HALFWAY	CGRectMake(-31.0, 0.0, SWITCH_WIDTH, SWITCH_HEIGHT)
...
- (void)setupUserInterface
{
	...
	bg.image = [UIImage imageNamed:@"setupmenu-switch-groove-on.png"];
	...
	foreground.image = [UIImage imageNamed:@"setupmenu-switch-handle.png"];
...
- (void)setOn:(BOOL)on animated:(BOOL)animated
{
	...
	if (_on)
	{
		...
		self.backgroundImage.image = [UIImage imageNamed:@"setupmenu-switch-groove-on.png"];
	}
	else
	{
		self.switchImage.frame = RECT_FOR_OFF;
		self.backgroundImage.image = [UIImage imageNamed:@"setupmenu-switch-groove-off.png"];
	}
}
